...
# Читаем DEBUG из .env (по умолчанию False для продакшена)
DEBUG = os.getenv('DEBUG', 'False') == 'True'

# Читаем ALLOWED_HOSTS из .env (разделяем запятыми)
...
# Подключаем PostgreSQL и читаем параметры из .env
DATABASES = {
    'default': {
...
# Статика и Медиа
STATIC_URL = '/static/'
STATIC_ROOT = BASE_DIR / 'static'  # <-- ВОТ ЭТА СТРОКА РЕШАЕТ ОШИБКУ collectstatic
